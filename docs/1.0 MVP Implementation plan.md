...
#### 2. Timeline Components (Implemented)
```swift
// TimelineStrip: 56pt glass band with markers mapped to time
// - Snap-to-nearest on tap/drag (≥32pt hit area)
// - VoiceOver: Adjustable, descriptive labels
// ShotChipsRow: 44pt-high scrollable chips + Prev/Next
// - Chips show FH/BH and score; keeps selection centered
```
