...
- Views
  - `MainView.swift`: Single scrollable dashboard. Shows `CoachCard` and a list of `VideoSessionCard`s. Floating action button opens `RecordOptionsModal` for Record/Upload.
