...
- Core
  ...
  - `TennisObjectDetector.swift`: YOLO11-based detection of tennis balls and rackets in video frames; handles device orientation and coordinate transformation; provides confidence-based filtering.
...
- Views
  ...
  - `AnalysisView.swift`: Presents comprehensive metrics, insights, score, and enhanced navigation controls with `TimelineStripEnhanced`; only accessible when session.processingStatus is complete; integrates object detection visualization and contact point analysis.
