...
// UI States
Recording:        Red (#FF3B30) with pulse
...
- **Bottom control bar**: 3 buttons inline (Upload | Record | History)
- **Recording state**: Red pulse animation on button
...
### Key Animations
- **Record button**: Pulse when recording (1.1x scale)
...
```swift
Size: 72pt diameter
Colors: White → Red (recording)
Animation: Scale 1.0 → 1.1 pulse
Shadow: 8pt blur, 50% opacity
```
